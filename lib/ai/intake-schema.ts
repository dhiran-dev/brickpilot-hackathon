...
export const nlIntakeExtractionSchema = z.object({
  ...
  architecturalStyle: z.enum(["contemporary_tropical", "warm_minimal", "kerala_contemporary", "modernist", "courtyard_vernacular"]).optional(),
  formStrategy: z.enum(["compact", "stepped_terraces", "courtyard", "articulated_wings"]).optional(),
  roofCharacter: z.enum(["flat_parapet", "sloped", "mixed"]).optional(),
  materialDirection: z.enum(["warm_natural", "light_mineral", "earthy_textured", "monochrome"]).optional(),
