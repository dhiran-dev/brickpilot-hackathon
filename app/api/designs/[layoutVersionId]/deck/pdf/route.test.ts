...
const { GET } = await import("@/app/api/designs/[layoutVersionId]/deck/pdf/route");
const context = { params: Promise.resolve({ layoutVersionId: "00000000-0000-0000-0000-000000000000" }) };

describe("GET /api/designs/[layoutVersionId]/deck/pdf", () => {
  test("rejects unauthenticated requests", async () => {
    const response = await GET(new Request("http://localhost/api/designs/id/deck/pdf"), context);
